...
export function buildDefaultCosts(category?: string): CostEntry[] {
  ...
  // Plumbing/Electrical/Painters/Pet Grooming/House Cleaning/Mobile Tire Repair/Appliance Repair/Grill Cleaning/Dryer Vent Cleaning: Service Call only
  if (c === "plumbing" || c === "electrical" || c === "painters" || c === "pet grooming" || c === "house cleaning" || c === "mobile tire repair" || c === "appliance repair" || c === "grill cleaning" || c === "dryer vent cleaning") {
    return [
      { cost_kind: "service_call", amount: null, unit: "visit", notes: null },
    ];
  }
