      ...
      <Card className="w-full" data-vendor-id={vendor.id} data-vendor-name={vendor.name}>
        <CardContent className="p-3 space-y-3">
          ...
          <div className="flex items-center gap-3 mb-2">
            <span className="bg-blue-500 text-white text-sm font-semibold px-3 py-1 rounded-lg shrink-0">#{rank}</span>
          ...
          <div className="flex items-center justify-between gap-3 mb-4">
            ...
            >
              <Star
                size={14}
                className={userReviews?.has(vendor.id) ? "fill-current text-green-600" : "text-blue-600"}
              />
          ...
          <div className="flex gap-2 pt-2">
            ...
            <Button
              variant="outline"
              size="sm"
              className={`flex-1 text-xs ${userHasCosts ? "border-green-500 text-green-700 hover:bg-green-50" : ""}`}
              onClick={() => {
            ...
            >
              {userHasCosts && "✓ "}💰{" "}
              {(() => {
                const costsWithAmounts =
                  vendorCosts?.filter((c) => c.amount !== null && c.amount !== undefined && c.amount > 0) || [];
            ...
            {showContact && !contactRevealed && (
              <Button variant="outline" size="sm" className="flex-1 text-xs" onClick={handleContactButtonClick}>
                📞 Contact
              </Button>
            )}
              ...
              <div className="flex-1 flex flex-col gap-1.5">
                {isContactInfoPending(vendor.contact_info) ? (
                  <div className="bg-orange-50 border border-orange-200 rounded-md p-2">
                    <p className="text-xs text-orange-800 font-medium mb-1">Contact info coming soon!</p>
                    <Button
                      variant="default"
                      size="sm"
                      onClick={() => {
                  ...
                  <>
                    ...
                    <div className="flex gap-1.5">
                      <Button variant="outline" size="sm" onClick={handleCall} className="flex-1 text-xs">
                        <Phone size={14} />
                      </Button>
                      <Button variant="outline" size="sm" onClick={handleText} className="flex-1 text-xs">
                        <MessageSquare size={14} />
                      </Button>
                      <Button variant="outline" size="sm" onClick={handleCopyNumber} className="flex-1 text-xs">
                        <Copy size={14} />
                      </Button>
                    </div>
                  </>
